...
### Via npx add-skill
```bash
npx add-skill github:skillzmarket/skillzmarket/packages/openclaw-skill
```

### Via openskills
```bash
npx openskills install skillzmarket/skillzmarket
```

### Manual installation
```bash
git clone https://github.com/skillzmarket/skillzmarket
cp -r skillzmarket/packages/openclaw-skill ~/.openclaw/skills/skillzmarket
